						...
						<div class="row align-items-start align-items-xl-center">
							<div class="col-lg-4 offset-lg-1 col-12 order-1">
								<div class="about-image">
									<img src="https://placehold.co/570x855" alt="about image">
								</div>
							</div>
								...
								<div class="row align-items-end">
									...
									<div class="col-xl-7 col-lg-6 col-12 order-first order-lg-2">
										<div class="g-photo-image">
											<img src="https://placehold.co/670x447" alt="portfolio image">
										</div>
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-lg-6 order-1">
									<div class="row g-photo-thumbs">
										<div class="col-lg-12">
											<img src="https://placehold.co/670x447" alt="portfolio thumb">
										</div>
										<div class="col-lg-12">
											<img src="https://placehold.co/670x447" alt="portfolio thumb">
										</div>
