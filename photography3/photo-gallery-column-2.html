...
<body>
  ...
  <![endif]-->
          ...
          <div class="mobile-menu-wrapper d-block d-lg-none">
              <div class="mobile-menu clearfix">
                  <a href="index.html" class="mobile-logo">
                      <img src="src/assets/img/logo/logo.png" alt="mobile logo">
                  </a>
              </div>
          </div>
      </div>
				...
				<div class="container">
					...
					<div class="portfolio-filters">
						...
						<div class="portfolio-views">
							<a href="photo-gallery-column-2.html"><i class="fa fa-th-large" aria-hidden="true"></i></a>
							<a href="photo-gallery-column-3.html"><i class="fa fa-th" aria-hidden="true"></i></a>
						</div>
					</div>
						...
						<div class="col-lg-6 col-md-6 col-12 portfolio-item portfolio-filter-graphic portfolio-filter-design">
							<div class="portfolio">
								<div class="portfolio-image">
									<img src="https://placehold.co/910x607" alt="portfolio image">
								</div>
								<div class="portfolio-content">
									<a href="https://placehold.co/910x607" class="portfolio-zoom-button"><i class="fa fa-search-plus"></i></a>
                    ...
                    <div class="row">
                        <div class="col-12 text-center mt-5">
                            <a href="photo-gallery.html" class="button" data-content="View More">
                                <span>View More</span>
                            </a>
                        </div>
                    </div>
	...
	<!-- Js Files -->
	<script src="src/assets/js/modernizr-3.11.2.min.js"></script>
